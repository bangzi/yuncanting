...
//{
//    
//    [[UIApplication sharedApplication]registerForRemoteNotifications];//进行注册
//}
 ...
 *
 *  @param application
 *  @param deviceToken token NNSdata 类型
 */
//- (void)application:(UIApplication *)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken
//{
//
//    if (![UUNotificationSetting isAllowedNotification]) {
//        UIAlertView *view = [[UIAlertView alloc] initWithTitle:@"提示" message:@"请在设置->通知中打开" delegate:nil cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
//        [view show];
//    }
//
//    NSString *token = [[deviceToken description] stringByTrimmingCharactersInSet:[NSCharacterSet characterSetWithCharactersInString:@"<>"]];
//    
//   NSString *customToken  = [token stringByReplacingOccurrencesOfString:@" " withString:@""];
//    
//    [UULocalPersistenceUtil sharedInstance].pushToken = customToken;
//    NSLog(@"%@",customToken);
//    
////    [self sendProviderDeviceToken:customToken];
//    
//}
/**
 *  app 在前台运行时收到推送调用
 *  app 退出到后台出现通知消息，点开后会调用
 *  二者区别applicationState
 *
 *  @param application
 *  @param userInfo    推送的数据
 */
...
//        NSLog(@"%@",dictionary[@"alert"]);
//  //  }
//    NSLog(@"状态--%ld",(long)application.applicationState);
//    if ([_handleNotification handlePushNotification:userInfo state:application.applicationState viewController:self.window.rootViewController managerObjectContext:self.managedObjectContext]) {
//        
//    }
//    
//    if ([_handleNotification handleAppDescribePushNotification:userInfo state:application.applicationState viewController:self.window.rootViewController managerObjectContext:self.managedObjectContext]) {
//        
//    }
//    
//    
...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo fetchCompletionHandler:(void (^)(UIBackgroundFetchResult result))completionHandler{
    ...
    BOOL ret = [[MDMNotifPushUtils shared] handlePushNotification:userInfo completed:^{
        //必须调用completionHandler，不然会出问题。
        completionHandler(UIBackgroundFetchResultNewData);
    }];
